...
class Location:
    ...
    def afficher_toutes_locations(self):
        ...
        headers = ["Numero","Type","Marque","Modele","Date Debut","Date fin","Durée (jours)","Prix Total (DH)" ,"Prix/Jours"]
        table_data = []
        ...
        for i, location in enumerate(Location.liste_locations, 1):
            ...
            row = [
                ...
                location.dateFin.strftime("%d/%m/%Y"),
                duree,
                f"{prix:.2f}",
                f"{location.vehicule.prixLocation:.2f}"
            ]
    ...
    def ajouter_location(self):
        ...
        try:
            ...
            print("✔️ Location ajoutée avec succès! ✔️")
...
def afficher_banniere():
    print("\n" + "=" * 60)
    print("🚗  SYSTÈME DE GESTION DES LOCATIONS DE VEHICULS  🏍")
    print("=" * 60)
